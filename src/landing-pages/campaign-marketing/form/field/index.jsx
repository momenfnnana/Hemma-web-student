...
export default function CampaignField({label,col="col-md-6 px-1 mt-4",values,onChange = ()=>{},name,errors,setErrors,defaultError,required}) {
    ...
    return (
        ...
        <div className="campaign-field position-relative">
            ...
            <input required className={className} value={value} onInvalid={(e)=>{setErrors({...errors, [name]: numberValidationError})}}  placeholder={label} type="number" onChange={handleChange} pattern={/^05\d{8}$/} />
