...
export default function CampaignForm() {
  ...
  const onError = (err) => {
    ...
    if (hasSentBefore) hasSentBeforeAlert();
  };
  ...
  useEffect(() => {
    ...
    setReceiversMatchErrors(
      hasUniqueValues && "لا يمكن تكرار اسماء المرسل اليهم"
    );
  }, [values]);
  ...
  const submitDisabled =
    ...
    hasErros ||
    matchCondition ||
    receiversMatchErrors;

  return (
    <form className="mt-4" onSubmit={submitInvitation}>
      <span className="h3 gheed-black-color font-weight-600">
        يمكنك دعوة ٣ من أصدقاءك للاشتراك بدورات منصة همة التعليمية والحصول على
        مقعد مجاني في حال تم تسجيل اثنين من أصدقاءك في دورات القدرات لمنصة همة
        التعليمية تحصل على مقعد مجاني لدورة القدرات.
      </span>
      <CampaignField
