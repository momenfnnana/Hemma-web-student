    ...
    axios
      ...
      .then((response) => {
        this.props.history.push(
          `/categories/quick-questions/${categoryId}/exam/details/${response.data.data.id}`
        );
      })
      .catch((error) => {
        console.log(error);
            ...
            <div className="col-12">
              <div className="box-layout shadow-sm h-100 d-flex align-items-center justify-content-center flex-column pt-5 pb-5">
                ...
                <Link
                  ...
                  to={`/categories/details/${this.props.match.params.slug}/quick-questions/${this.props.match.params.categoryGroupId}`}
                >
