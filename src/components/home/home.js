              ...
              <div className="container">
                <div className="banner-text text-white">
                  ...
                  <h2 className="h2 m-0 animated bounceInDown">
                    أكثر من 25 سنة فى خدمة الطلاب والمعلمين
                  </h2>
                </div>
              </div>
            </div>
        ...
        >
          <div className="container">
            <header className="mb-5">
              ...
              >
                اجعل رحلتك التعليمية عميقة ومكثفة من خلال محتوى همة الاحترافي
              </h3>
              <h3
                ...
                data-aos-easing="ease-in-sine"
              >
                وفرنا لك أفضل المميزات لعملية تعليمية فعالة
              </h3>
            </header>
            <div className="row">
              <div
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <p className="description-card m-0 font-weight-bold">
                    من خلال خدمات الدعم المقدمة خلال رحلتك التعليمية معنا
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <p className="description-card m-0 font-weight-bold">
                    دورات مصممة بواسطة خبراء محترفين ومتخصصين
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <div className="text-center mb-4">
                  ...
                  <h5 className="main-color font-weight-bold">
                    نماذج محاكية للاختبارات
                  </h5>
                  <p className="description-card m-0 font-weight-bold">
                    تطبيقات محاكية عملية من خلال نماذج حديثة للاختبار
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="about-hemma">
                ...
                >
                  <h3 className="h3 text-center font-weight-bold mb-2">
                    كيف سهلت همة الاختبارات على الآلاف خلال 25 عام؟
                  </h3>
                  <h3 className="h3 text-center font-weight-bold">
                    هنا نستعرض بعض الأرقام والتى نعدها مصدر اعتزاز !
                  </h3>
                </header>
                <div className="row overflow-hidden">
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      <p className="font-weight-bold m-0 font-size-20">
                        بدأت خدمتنا للطلاب والمعلمين فى (1415 هـ) ووصلنا لكل بيت
                        بكتب التبسيط{" "}
                      </p>
                    </div>
                  </div>
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      <p className="font-weight-bold m-0 font-size-20">
                        مجموع المستفيدين من خدماتنا تجاوز 3 مليون مستفيد{" "}
                      </p>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      <p className="font-weight-bold m-0 font-size-20">
                        95% من مشتركينا حققوا مايطمحون له من درجات
                      </p>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div className="text-center mb-4">
                      ...
                      <p className="font-weight-bold m-0 font-size-20">
                        أكثر من 200 ألف مشترك فى الموقع
                      </p>
                    </div>
                  </div>
                </div>
