...
class CartSummaryComponent extends Component {
                ...
                <div className="pb-0 p-4">
                    ...
                    <div className="d-flex flex-row align-items-center justify-content-between">
                        <h4 className="light-text mt-2">
                            <span className="en-text">{cart ? formatPrice(cart.total) : "-"}</span>
                            {" "}
                            ريال
                        </h4>
     ...
     */
    onAddCoupon() {
        this.props.addCoupon(this.state.couponInputValue)
            .then(() => {
                this.setState({
                    couponInputValue: ""
                });
...
export const CartSummary = connect(mapStateToProps, actionCreators)(CartSummaryComponent);
